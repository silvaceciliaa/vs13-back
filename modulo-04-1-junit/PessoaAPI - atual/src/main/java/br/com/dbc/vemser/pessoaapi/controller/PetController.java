...
//    @GetMapping("/{idPet}")
//    public ResponseEntity<List<PetDTO>> listByIdEndereco(@PathVariable("idPet") int id){
//        List<PetDTO> pets =  petService.listByEndereco(id);
//        return new ResponseEntity<>(pets, HttpStatus.OK);
//    }
//
//    @GetMapping("/{idPessoa}/pessoa")
//    public ResponseEntity<List<PetDTO>> listByName(@PathVariable("idPessoa") int id){
//        List<PetDTO> pets = petService.listByPeople(id);
//        return new ResponseEntity<>(pets, HttpStatus.OK);
//    }
